...
import { handleLogin, handleSignUp } from "./store.js";
import MyButton from "@components/Button/MyButton.vue";
import MyTextField from "@components/TextField/MyTextField.vue";
import { loginSchema, signupSchema } from "./schema.js"; // Import the schema
    ...
    try {
      ...
      if (error.inner) {
        ...
        error.inner.forEach((err) => {
          ...
          } else if (err.path === "confirm_password") {
            confirm_passwordError.value = err.message;
          }
        });
      }
    } finally {
        ...
        <div v-if="selectedTab === 'register'">
          ...
          <div class="mb-6">
            ...
            <MyTextField
              ...
              :error-message="confirm_passwordError"
          ...
          <div class="flex justify-center">
            <MyButton
              ...
              @click="onSubmit"
            >
              <p class="text-md-semibold">Register</p>
            </MyButton>
          </div>
        </div>
